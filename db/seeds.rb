...
puts "Seeding players"
    ...
    player8 = Player.create!(name: "Ninja", age: rand(18...30), country: "USA", years_of_experience: rand(0...10), photo_url: "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcTtCV4pCr9jyFv6V3xUGIGDkrPaoKuJivlgD3wWNeW8sneEGhuW");
...
puts "Seeding games"
    ...
    game1 = Game.create!(cost: rand(20..50), name: "Minecraft", category: Faker::Game.genre, rate: rand(1...10), average_length: rand(30...60), console: console3, storage_space: rand(1...100), img_url: "https://image.api.playstation.com/vulcan/img/cfn/11307uYG0CXzRuA9aryByTHYrQLFz-HVQ3VVl7aAysxK15HMpqjkAIcC_R5vdfZt52hAXQNHoYhSuoSq_46_MT_tDBcLu49I.png");
    game2 = Game.create!(cost: rand(20...50), name: "Fornite", category: Faker::Game.genre, rate: rand(1...10), average_length: rand(30...60), console: console4, storage_space: rand(1...100), img_url: "https://cdn2.unrealengine.com/Fortnite%2Fblog%2Fseason-5%2FBR05_Social_-Launch_Hero-Line-Up-1920x1080-2117b3d382b87887271a17a78122b7316ff0c1c0.jpg");
    game3 = Game.create!(cost: rand(20...50), name: "GTA V", category: Faker::Game.genre, rate: rand(1...10), average_length: rand(30...60), console: console2, storage_space: rand(1...100), img_url: "https://upload.wikimedia.org/wikipedia/en/a/a5/Grand_Theft_Auto_V.png");
    game4 = Game.create!(cost: rand(20...50), name: "Zelda Breath Of The Wild", category: Faker::Game.genre, rate: rand(1...10), average_length: rand(30...60), console: console3, storage_space: rand(1...100), img_url: "https://cdn.vox-cdn.com/thumbor/Xm1C9TWbMK55zAnuR09oD6XMyRI=/0x0:1024x1024/1200x800/filters:focal(444x567:606x729)/cdn.vox-cdn.com/uploads/chorus_image/image/65813576/mobile_MarioKartTour_screen_01.0.png");
    game5 = Game.create!(cost: rand(20...50), name: "Spiderman Miles Morales", category: Faker::Game.genre, rate: rand(1...10), average_length: rand(30...60), console: console1, storage_space: rand(1...100), img_url: "https://image.api.playstation.com/vulcan/ap/rnd/202008/1020/PRfYtTZQsuj3ALrBXGL8MjAH.jpg");
    game6 = Game.create!(cost: rand(20...50), name: "Mario Kart 8", category: Faker::Game.genre, rate: rand(1...10), average_length: rand(30...60), console: console3, storage_space: rand(1...100), img_url: "https://www.nintendo.com//content/dam/noa/en_US/games/switch/m/mario-kart-8-deluxe-switch/mario-kart-8-deluxe-switch-hero.jpg");
    game7 = Game.create!(cost: rand(20...50), name: "Jump Force", category: Faker::Game.genre, rate: rand(1...10), average_length: rand(30...60), console: console4, storage_space: rand(1...100), img_url: "https://cdn-ext.fanatical.com/production/product/1280x720/840c4611-c0a4-44d2-a946-d6ad8a8ed07d.jpeg");
    game8 = Game.create!(cost: rand(20...50), name: "Halo Infinite", category: Faker::Game.genre, rate: rand(1...10), average_length: rand(30...60), console: console2, storage_space: rand(1...100), img_url: "hhttps://compass-ssl.xbox.com/assets/49/b6/49b6313d-375e-49ba-b08b-3e7bf67d8928.jpg?n=Halo-Infinite_GLP-Page-Hero-1084_Poster-Image_1920x1080.jpg");
    game9 = Game.create!(cost: rand(20...50), name: "Flight Simulator 2020", category: Faker::Game.genre, rate: rand(1...10), average_length: rand(30...60), console: console2, storage_space: rand(1...100), img_url: "https://www.epingi.com/wp-content/uploads/2020/05/Microsoft-Flight-Simulator-2020-Alpha-3-PC-Version-Full-Game-Setup-Free-Download.jpg");
    game10 = Game.create!(cost: rand(20...50), name: "Red Dead Redemption II", category: Faker::Game.genre, rate: rand(1...10), average_length: rand(30...60), console: console1, storage_space: rand(1...100), img_url: "https://api.cdkeybay.com/static/bbc99843f82c0212477c258f.jpg");
    game11 = Game.create!(cost: rand(20...50), name: "Resident Evil Village", category: Faker::Game.genre, rate: rand(1...10), average_length: rand(30...60), console: console1, storage_space: rand(1...100), img_url: "https://www.residentevil.com/village/assets/images/common/share.png");
    game12 = Game.create!(cost: rand(20...50), name: "Sekiro Shadows Die Twice", category: Faker::Game.genre, rate: rand(1...10), average_length: rand(30...60), console: console4, storage_space: rand(1...100), img_url: "https://compass-ssl.xbox.com/assets/d5/54/d554ce9b-cca1-4ad0-88d3-6811cb007ddc.jpg?n=Sekiro-Shadows-Die-Twice_GLP-Page-Hero-1084_1920x1080.jpg");
